const local: App.I18n.Schema = {
  ...
  condor: {
    ...
    component: {
      ...
      content_language_switching: '内容语言切换'
    },
    route: {
      configuration_view: '配置查看',
      configuration_edit: '配置编辑',
      configuration_add: '配置添加',
      configuration_delete: '配置删除',
      configuration_save: '配置保存',
      send_test_email: '发送测试邮件',
      group_bulk_actions: '分组批量操作',
      group_add: '分组添加',
      group_edit: '分组编辑',
      group_delete: '分组删除',
      group_view: '分组查看',
      select_data_list: '数据选择列表',
      data_bulk_actions: '数据批量操作',
      delete_data: '数据删除',
      edit_data: '数据编辑',
      add_data: '数据添加',
      view_data: '数据查看',
      select_type_list: '类型选择列表',
      type_bulk_actions: '类型批量操作',
      delete_type: '类型删除',
      edit_type: '类型编辑',
      add_type: '类型添加',
      view_type: '类型查看',
