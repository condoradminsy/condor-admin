const local: App.I18n.Schema = {
  ...
  condor: {
    ...
    component: {
      ...
      content_language_switching: 'Content Language Switching (i18n)'
    },
    route: {
      ...
      group_bulk_actions: 'Group Bulk Actions',
      group_delete: 'Delete Group',
      group_edit: 'Edit Group',
      group_add: 'Add Group',
      group_view: 'View Group',
      select_data_list: 'Select Data List',
      data_bulk_actions: 'Data Bulk Actions',
      delete_data: 'Delete Data',
      edit_data: 'Edit Data',
      add_data: 'Add Data',
      view_data: 'View Data',
      select_type_list: 'Select Type List',
      type_bulk_actions: 'Type Bulk Actions',
