    ...
    type Schema = {
      ...
      condor: {
        ...
        component: {
          ...
          content_language_switching: string;
        };
        route: {
          configuration_view: string;
          configuration_edit: string;
          configuration_add: string;
          configuration_delete: string;
          configuration_save: string;
          send_test_email: string;
          group_bulk_actions: string;
          group_delete: string;
          group_edit: string;
          group_add: string;
          group_view: string;
          select_data_list: string;
          data_bulk_actions: string;
          delete_data: string;
          edit_data: string;
          add_data: string;
          view_data: string;
          select_type_list: string;
          type_bulk_actions: string;
          delete_type: string;
          edit_type: string;
          add_type: string;
          view_type: string;
